...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-md border border-gray-200 bg-white px-3 py-2 text-sm ring-offset-white placeholder:text-gray-500 hover:border-summit-300 focus:border-summit-700 focus:outline-none focus:ring-transparent focus:hover:border-summit-700 disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-800 dark:bg-gray-950 dark:placeholder:text-gray-400 [&>span]:line-clamp-1",
      className,
    )}
    {...props}
  >
